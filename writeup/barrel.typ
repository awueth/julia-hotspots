...
#proof[
  ...
  $
  Since $Q$ and $V$ are invariant under both reflections, $r_i (Omega)=Omega$ for $i=1,2$. Hence the operators $R_i u := u compose sigma_i$ are unitary involutions on $L^2(Omega)$ and preserve $H^1(Omega)$.
