...
For the second step we interpret the eigenvalue equation $(-Delta + nabla V dot nabla) psi_1 = lambda_1 psi_1$ as a transport equation. Rearranging the terms and dividing by $abs(nabla V)$ yields
$
